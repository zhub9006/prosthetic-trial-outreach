...
- **422 studies** match "lower limb prosthetic" on ClinicalTrials.gov; only **2.4% are Phase III/IV** and **13.7% are industry-sponsored**
...
- **Shirley Ryan AbilityLab** scores ⭐⭐⭐⭐ (4/5) as a clinical anchor — excellent credibility and transit access, but paid parking and affluent neighborhood create access barriers
...
| Analysis | Result |
|---|---|
| Total studies (lower limb prosthetic) | 422 unique studies |
